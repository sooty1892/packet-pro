...
public class Pktcap implements Runnable {
	...
	public static void main(String[] args) {
                ...
                System.out.println((int)Utils.swapl2b(total_length));
                System.out.println((int)Utils.swapl2b(packet_id));
                System.out.println((int)Utils.swapl2b(fragment_offset));
                System.out.println((int)time_to_live);
                System.out.println((int)next_proto_id);
                System.out.println((int)Utils.swapl2b(hdr_checksum));
                System.out.println((int)Utils.swapl2b(src_addr));
                System.out.println((int)Utils.swapl2b(dst_addr));
	}
